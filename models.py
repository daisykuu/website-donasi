...
from datetime import datetime  # ✅ Ini penting ditambahkan
...
class User(db.Model, UserMixin):
    ...
    username = db.Column(db.String(50), unique=True, nullable=True)  # Sementara nullable=True
...
class AdminPerpus(db.Model):
    ...
    password = db.Column(db.String(200), nullable=False)  # ⬅️ Ini WAJIB ada
